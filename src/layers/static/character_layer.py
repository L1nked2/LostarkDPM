from db.constants.common import CRITICAL_RATE_PER_CRIT, COOLDOWN_PERCENTAGE_PER_SWIFTNESS, ATTACK_SPEED_PER_SWIFTNESS, MOVEMENT_SPEED_PER_SWIFTNESS
...
class CharacterLayer:
    ...
    def reset_stat(self):
        ...
        self.additional_attack_power = 0  # 추가 공격력(저받&질증&아드&에포)
        self.additional_damage = 0  # 추가피해(equipment(구원,악몽,갈망,파괴), 무품)
        ...
        self.attack_speed = 1 + swiftness * ATTACK_SPEED_PER_SWIFTNESS
        self.movement_speed = 1 + swiftness * MOVEMENT_SPEED_PER_SWIFTNESS
    ...
    def get_character_detail(self):
        ...
        target_detail = [
            # base attack terms
            'attack_power_base', 'additional_attack_power', 'additional_damage', 'damage_multiplier',
            # crit terms
