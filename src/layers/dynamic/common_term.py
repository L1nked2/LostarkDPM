...
"""
def base_damage_term(default_damage, attack_power, default_coefficient):
  if default_damage < 0 or attack_power < 0 or default_coefficient < 0:
    ...
    return 0
  return default_damage + attack_power * default_coefficient
"""
...
class CommonTerm(TermBase):
    ...
    def base_damage_term(cls):
        return cls('Base_Damage_Term', ['default_damage', 'attack_power', 'default_coefficient'], base_damage_term)
